...
import { AlertTriangle, BookOpen, Edit, Trash2 } from 'lucide-react'
...
const TeacherHomeWorkList = () => {
  ...
  /* ================= FETCH ================= */
  useEffect(() => {
    if (user?.profile?._id) fetchHomework()
      ...
      <div className="px-4 py-3 bg-white rounded border mb-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-gray-500">View all assigned homework</p>
          </div>
        </div>
      </div>
