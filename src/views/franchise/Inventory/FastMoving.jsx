...
export default function FastMoving() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true)
    try {
      const res = await getRequest(`/franchise/inventory/fast-moving?period=${period}`)
  ...
  return (
    <div style={{ fontFamily: 'Inter, sans-serif', display: 'flex', flexDirection: 'column', gap: 18 }}>
      <div>
        ...
        <p style={{ fontSize: 12, color: '#9ca3af', margin: '2px 0 0' }}>Top selling medicines by quantity</p>
      </div>
