  ...
  if (loading)
    return (
      <div className="absolute inset-0 z-30 bg-white/70 flex flex-col items-center justify-center">
        <Loader /> Loading Teacher Profile...
      </div>
    )
  if (!teacher)
    return (
    ...
    <div className="min-h-screen bg-gray-100">
      <div className="mb-4 ">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2  text-blue rounded-md hover:text-gray-700 transition"
        >
          ← Back
        </button>
      </div>{' '}
    ...
    <div className="space-y-6">
      <Section title="Personal Details">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <DataRow label="Category" value={teacher.category?.name || '-'} />{' '}
